#This module will create a visual appealling output
import pprint

#This string will be the target of our data analysis
...
"""
#This dictionary will serve as data storage device to count number of occurances of a target character
#Example value pair: "R" : 12
Count = {} 

#The for loop goes through every value in the string, than transfroms it into uppercase
for TargetCharacter in RJ_Book.upper():
    #Enters a character into the dictionary as a key, then sets the value to 0
    Count.setdefault(TargetCharacter, 0)
    #Counts everytime a character is mentioned by finding the appropriate key and increasing the value by one
    Count[TargetCharacter] = Count[TargetCharacter] + 1
